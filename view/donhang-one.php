...
?>
    ...
    <section class="w-[1240px] rounded-md h-auto mx-auto border border-gray-600 m-12 max-lg:w-full">
        ...
        <div class="flex w-auto m-5 gap-6 max-lg:flex-col max-lg:text-xs">
            <div class="w-[64%] flex justify-between border-black border rounded-md max-lg:w-full" >
                <div class="w-1/2">
            ...
            <div class="w-[calc(36%-24px)] border border-black rounded-md max-lg:w-full">
                <div class="w-auto">
        ...
        <section class="px-5  max-lg:hidden">
